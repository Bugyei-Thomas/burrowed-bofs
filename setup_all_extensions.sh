...
echo "=========================================="
echo ""
echo "This will setup all 7 BOF projects as Sliver extensions:"
echo "  1. BOF-enumfiles (1 extension)"
echo "  2. Defender-Exclusions-Creator-BOF (1 extension)"
echo "  3. PrintSpoofer-BOF (1 extension)"
echo "  4. PrivKit (10 extensions)"
echo "  5. SQL-BOF (28 extensions)"
echo "  6. UAC-BOF-Bonanza (7 extensions)"
echo "  7. sliver_extension_uac_bypass_cmstp (1 extension)"
echo ""
echo "Total: 49 extensions"
echo "=========================================="
echo ""
...
run_setup "$BOFTAKE_DIR/PrintSpoofer-BOF" "setup_sliver_extension.sh" "PrintSpoofer-BOF"
...
echo "=========================================="
echo "Projects successfully setup: $total_success / 7"
if [ $total_failed -gt 0 ]; then
    echo "Projects failed: $total_failed / 7"
fi
echo ""
