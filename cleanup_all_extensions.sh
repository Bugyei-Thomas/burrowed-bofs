...
echo "=========================================="
echo ""
echo "This will remove all 47 BOF extensions from:"
echo "  $EXTENSIONS_DIR"
echo ""
...
# Remove old lowercase-with-hyphens names
remove_extension "alwaysinstallelevated-check"
remove_extension "autologon-check"
remove_extension "credentialmanager-check"
remove_extension "hijackablepath-check"
remove_extension "modifiableautorun-check"
remove_extension "modifiablesvc-check"
remove_extension "powershellhistory-check"
remove_extension "tokenprivileges-check"
remove_extension "uacstatus-check"
remove_extension "unquotedsvcpath-check"
echo ""
